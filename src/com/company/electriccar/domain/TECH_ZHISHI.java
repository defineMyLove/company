 ...
 * 
 */
public class TECH_ZHISHI extends BaseBean{
     ...
     * 设置ID
     */
	public TECH_ZHISHI setId(String id) {
		this.id = id;
	...
	public String getUpdateSql() {
		StringBuffer sBuffer = new StringBuffer("update TECH_ZHISHI set ");
			if (isSetted_title) {
	...
	public String getInsertSql() {
		StringBuffer sBuffer = new StringBuffer("insert into TECH_ZHISHI(");
		 ...
		 * 2014-04-22 hh:06
		 */
		public TECH_ZHISHI setTitle(String title) {
			this.title = title;
		 ...
		 * 2014-04-22 hh:06
		 */
		public TECH_ZHISHI setContent(String content) {
		 ...
		 * 2014-04-22 hh:06
		 */
		public TECH_ZHISHI setCreate_time(Long create_time) {
		 ...
		 * 2014-04-22 hh:06
		 */
		public TECH_ZHISHI setQuery_count(Integer query_count) {
		...
		@Override
		public TECH_ZHISHI getInstanceById() {
			if (StringUtils.isBlank(id)) {
		...
		@Override
		public TECH_ZHISHI queryForBean() {
			StringBuffer sBuffer = new StringBuffer("select * from TECH_ZHISHI where ");
			if(isSetted_id){
		...
		public TECH_ZHISHI insertOrUpdate(){
		...
		public Map getBeanMapById() {
			...
			return dao.queryForMap("select * from TECH_ZHISHI where id=:id",BEAN_VALUES);
		}
		...
		public TECH_ZHISHI newInstance(){
			return new TECH_ZHISHI();
		}
