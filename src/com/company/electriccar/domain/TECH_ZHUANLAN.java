 ...
 * 
 */
public class TECH_ZHUANLAN extends BaseBean{
	...
	public TECH_ZHUANLAN() {
		initBeanValues();
	}
	
	public TECH_ZHUANLAN(String id) {
		super();
		this.id = id;
		initBeanValues();
		BEAN_VALUES.put("id",id);
     ...
     * 设置ID
     */
	public TECH_ZHUANLAN setId(String id) {
		this.id = id;
	...
	public String getUpdateSql() {
		StringBuffer sBuffer = new StringBuffer("update TECH_ZHUANLAN set ");
			if (isSetted_title) {
	...
	public String getInsertSql() {
		StringBuffer sBuffer = new StringBuffer("insert into TECH_ZHUANLAN(");
		...
		@Override
		public TECH_ZHUANLAN getInstanceById() {
			if (StringUtils.isBlank(id)) {
		...
		@Override
		public TECH_ZHUANLAN queryForBean() {
			StringBuffer sBuffer = new StringBuffer("select * from TECH_ZHUANLAN where ");
			if(isSetted_id){
		...
		public TECH_ZHUANLAN insertOrUpdate(){
		...
		public Map getBeanMapById() {
			...
			return dao.queryForMap("select * from TECH_ZHUANLAN where id=:id",BEAN_VALUES);
		}
		...
		public TECH_ZHUANLAN newInstance(){
			return new TECH_ZHUANLAN();
		}
