 ...
 * 
 */
public class YEJI_FENLEI extends BaseBean{
     ...
     * 设置ID
     */
	public YEJI_FENLEI setId(String id) {
		this.id = id;
	...
	public String getUpdateSql() {
		StringBuffer sBuffer = new StringBuffer("update YEJI_FENLEI set ");
			if (isSetted_name) {
	...
	public String getInsertSql() {
		StringBuffer sBuffer = new StringBuffer("insert into YEJI_FENLEI(");
		...
		@Override
		public YEJI_FENLEI getInstanceById() {
			if (StringUtils.isBlank(id)) {
		...
		@Override
		public YEJI_FENLEI queryForBean() {
			StringBuffer sBuffer = new StringBuffer("select * from YEJI_FENLEI where ");
			if(isSetted_id){
		...
		public YEJI_FENLEI insertOrUpdate(){
		...
		public Map getBeanMapById() {
			...
			return dao.queryForMap("select * from YEJI_FENLEI where id=:id",BEAN_VALUES);
		}
		...
		public YEJI_FENLEI newInstance(){
			return new YEJI_FENLEI();
		}
