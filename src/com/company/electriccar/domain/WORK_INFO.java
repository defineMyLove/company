 ...
 * 
 */
public class WORK_INFO extends BaseBean{
     ...
     * 设置ID
     */
	public WORK_INFO setId(String id) {
		this.id = id;
	...
	public String getUpdateSql() {
		StringBuffer sBuffer = new StringBuffer("update WORK_INFO set ");
			if (isSetted_title) {
	...
	public String getInsertSql() {
		StringBuffer sBuffer = new StringBuffer("insert into WORK_INFO(");
		 ...
		 * 2014-04-22 hh:06
		 */
		public WORK_INFO setTitle(String title) {
			this.title = title;
		 ...
		 * 2014-04-22 hh:06
		 */
		public WORK_INFO setContent(String content) {
		 ...
		 * 2014-04-22 hh:06
		 */
		public WORK_INFO setCreate_time(Long create_time) {
		 ...
		 * 2014-04-22 hh:06
		 */
		public WORK_INFO setQuery_count(Integer query_count) {
		...
		@Override
		public WORK_INFO getInstanceById() {
			if (StringUtils.isBlank(id)) {
		...
		@Override
		public WORK_INFO queryForBean() {
			StringBuffer sBuffer = new StringBuffer("select * from WORK_INFO where ");
			if(isSetted_id){
		...
		public WORK_INFO insertOrUpdate(){
		...
		public Map getBeanMapById() {
			...
			return dao.queryForMap("select * from WORK_INFO where id=:id",BEAN_VALUES);
		}
